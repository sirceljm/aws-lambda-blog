...
co(function *(){
  ...
  var hostedZonesOptionsPromise = new Promise(function(resolve, reject){
  ...
  var certificatesPromise = new Promise(function(resolve, reject){
  ...
  yield new Promise(function(resolve, reject){
    var converter = new Converter({});
    converter.fromFile("./install/install_categories_posts.csv",function(err,result){
      var params = {
        TableName: config.table_prefix+"_objects"
      };
      dynamodb.waitFor('tableExists', params, function(err, data) {
